...
export const Carrera = ()=>{
    ...
    return <Box sx={{display:'flex',justifyContent:'center'}}><FormGroup>
        {carreras.map(item=><FormControlLabel control={<Checkbox color="primary" name={item.id_carrera} checked={datos.carreras.some(aux=>aux==item.id_carrera)} onChange={handleChangeCarreras} />} label={item.descripcion}/>)}
    </FormGroup>
    </Box>
